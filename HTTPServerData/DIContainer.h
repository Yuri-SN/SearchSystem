...
class DIContainer {
  public:
     ...
     */
    std::shared_ptr<Core::Application::UseCases::SearchDocumentsUseCase> getSearchDocumentsUseCase();
  ...
  private:
    ...
    // Database
    std::shared_ptr<void> databaseConnection_;  // DatabaseConnection (void* чтобы не включать заголовок)
